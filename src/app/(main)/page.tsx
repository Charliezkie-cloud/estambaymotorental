      ...
      <section className="bg-[#010F1F] py-12">
        <div className="max-w-7xl mx-4 sm:mx-6 md:mx-8 lg:mx-10 xl:mx-auto space-y-6">
          <div className="space-y-4">
            ...
            <p className="text-[#94A3B8]">Our facility features two championship-standard courts designed with high-performance acrylic surfacing and professional LED lighting for night play.</p>
          </div>
